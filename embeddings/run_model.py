...
def cell_embeddings(model_name, model_path, images_folder, centers, output_file, inspection_file, channel_names, channel_substrings, num_workers, average):
    output = []
...
parser.add_argument('averages', type=lambda x: x.lower() in ['True'], nargs='?', const=True, default=False, help='whether to compute averages (True/False, default=False)')
